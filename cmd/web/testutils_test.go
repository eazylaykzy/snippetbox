...
// Implement the latest method on our custom testServer type. This makes a GET request to a given
// url path on the test server, and returns the response status code, headers and body
func (ts *testServer) latest(t *testing.T, urlPath string) (int, http.Header, []byte) {
...
func extractCSRFToken(t *testing.T, body []byte) string {
	// Use the FindSubmatch method to extract the token from the HTML body. Note that this returns an array with the
	// entire matched pattern in the first position, and the values of any captured data in the subsequent positions
